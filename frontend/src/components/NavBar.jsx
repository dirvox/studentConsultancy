...
import brandiconmd from '../assets/logo.png'


const programs = [
    { name: 'Bachelors', description: 'Study Bachelors in Germany', href: 'https://www.ug.dirvox.co.in/', icon: AcademicCapIcon },
    ...
    { name: 'Work in Germany', description: 'Start your Dream Career after 12th', href: 'https://www.ws.dirvox.co.in/', icon: BriefcaseIcon },
]
const callsToAction = [
                ...
                <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <Link to="/" className="-m-1.5 p-1.5">
                            <span className="sr-only">Dirvox</span>
                    ...
                    <Popover.Group className="hidden lg:flex lg:gap-x-12">
                        ...
                        {/* <Link to="/becomeConsultant" className="text-sm font-semibold leading-6 text-gray-700 hover:text-gray-500 duration-300 transition-colors">
                            Become Consultant
                        </Link> */}
                       {isLoggedIn && (
                        <Link
                    ...
                    {!isLoggedIn ? (
                        ...
                        <Link to="/signup" className="btn text-sm bg-primary text-white px-4 py-2 rounded-md">Signup</Link>
                        </>
                    ) : (
                        <>
                        {role !== "user" && (
                                <Link to="/adminzone" className="btn text-sm bg-primary text-white px-4 py-2 rounded-md">
                                ADMIN ZONE
                                </Link>
                            )}
                        <button onClick={handleLogout} className="btn text-sm bg-primary text-white px-4 py-2 rounded-md">Logout</button>
                        </>
                    )}
                        ...
                        <div className="mt-16 flow-root">
                            <div className="-my-6 divide-y divide-gray-500/10">
                                ...
                                <div className="py-6">
                                    ...
                                    <Link to="/login" className="block text-sm font-semibold leading-7 text-gray-700 hover:bg-gray-50 py-2">Login</Link>
<Link to="/signup" className="block text-sm font-semibold leading-7 text-primary hover:bg-gray-50 py-2">Signup</Link>
