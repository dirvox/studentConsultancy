        ...
        <div className="p-6 mx-auto max-w-sm sm:max-w-xl md:max-w-full lg:max-w-screen-xl">
                ...
                <div className="md:max-w-md lg:col-span-2">
                    ...
                    <div className="mt-4 lg:max-w-sm">
                        <p className="text-sm text-gray-700 leading-6">
                            Welcome to Dirvox International Education Consultancy, your trusted partner in the journey towards higher education in the world's top universities.
                        </p>
                    </div>
                </div>
                <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            <li>
                                <a
                                    href="https://www.ug.dirvox.in/" target='_blank'
                            ...
                            <li>
                                <a
                                    href="https://www.ws.dirvox.in/" target='_blank'
                                    className="text-gray-700 transition-colors duration-300 hover:text-deep-purple-accent-400 hover:text-gray-500" rel="noreferrer"
                                >
                                    Phd
                                </a>
            ...
            <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
                <p className="text-sm text-gray-600">
                    © Copyright 2023 Dirvox. All rights reserved.
                </p>
