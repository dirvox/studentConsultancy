...
const features = [
  {
    ...
    description:
      'Dirvox provides affordable study options, scholarships, and financial aid to make education accessible. They prioritize budget-friendly solutions for students, enabling them to pursue their dreams without financial barriers.',
    icon: BanknotesIcon,
  },
  {
    name: 'Comprehensive Programs and Resources',
    description:
      'Dirvox empowers students with programs and courses for academic and professional success. They offer resources for test prep, career guidance, and skill development. With tailored support, Dirvox helps students excel in academia and achieve career goals.',
    icon: BookOpenIcon,
  },
  {
    name: 'Excellent Job Opportunities',
    description:
      'Dirvox connects students to excellent job opportunities through industry connections and career development resources. They organize job fairs, internships, and workshops to help students succeed in the professional world. With Dirvox, students gain the skills and networking opportunities needed to stand out in the job market and secure desirable positions.',
    icon: BriefcaseIcon,
  },
  {
    name: 'Best University Admissions',
    description:
      'Dirvox secures top university admissions through personalized guidance. They help with applications, essays, and mock interviews to increase acceptance rates. For medical students, they provide assistance in exam prep and profile building for admission to prestigious medical schools.',
    icon: AcademicCapIcon,
  },
  {
    name: 'Guranteed Outcomes',
    description:
      'Dirvox guarantees successful outcomes by providing specialized training for high-paying careers. They support students in achieving their goals, including admission to top universities and securing jobs in their desired fields.',
    icon: CheckCircleIcon,
  },
  {
    name: 'Maximum Benefits',
    description:
      'Dirvox prioritizes student success through valuable resources, support, and guidance. They offer budget-friendly programs, exclusive materials, counseling, and networking opportunities for an enhanced educational journey.',
    icon: StarIcon,
  },
            ...
            <div className="max-w-xl mb-10 md:mx-auto text-center lg:max-w-2xl md:mb-12">
              ...
              <h2 className="max-w-lg mb-6 text-4xl font-semibold leading-none tracking-tight text-gray-800 sm:text-5xl md:mx-auto">
                <span className="relative inline-block">
                  ...
                  <span className="relative">Dirvox</span>
                </span>{' '}
                Programs are Budget-Friendly.
              </h2>
              <p className="text-sm text-gray-600 font-medium lg:text-base">
                The carefully hand-picked Dirvox Programs benefit you in a big way as they guarantee you financial freedom,
