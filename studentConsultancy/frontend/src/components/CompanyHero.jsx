        ...
        <div className="relative isolate overflow-hidden bg-white">
            ...
            <div className="px-10 mx-auto sm:px-20">
                ...
                <div className="relative mx-auto">
                    ...
                    className="sm:max-w-lg pt-44">
                        <motion.h1   initial={{ opacity : 0 , scale : 0 }}
                     animate={{ opacity : 1 , scale : 1 }}
                     transition={ { visualDuration : 0.5 , type : 'spring'  }}
                     className="text-4xl text-center font-semibold tracking-tight text-gray-800 sm:text-5xl sm:text-left">
                            Welcome to <br /><span className='text-primary sm:text-6xl'>Dirvox</span>
                        </motion.h1>
