            ...
            <div className="grid row-gap-8 sm:row-gap-0 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="p-8 sm:border-r lg:border-r-0">
                    <div className="max-w-md text-center">
                        ...
                        <p className="mb-3 text-sm text-gray-700 hover:text-gray-500 hover:no-underline duration-300 transition-colors">
                            <a href="http://google.co.in/maps/dir/''/Sk+Building+Material,+Dental+Jatroli+Road+Merath,+Sharoada+Puri+Phase+1+Meerut,+2Mjr%2BQg2,+Dantal+Jatoli+Road,+Shradhapuri+Phase+1,+Meerut+Delhi,+Uttar+Pradesh+250001/@29.0319594,77.6864795,17z/data=!4m13!4m12!1m5!1m1!1s0x390c6587024382db:0x70118e5eb3d4d067!2m2!1d77.6912375!2d29.0319612!1m5!1m1!1s0x390c6587024382db:0x70118e5eb3d4d067!2m2!1d77.6912375!2d29.0319612?entry=ttu&g_ep=EgoyMDI1MDQxMy4wIKXMDSoJLDEwMjExNDU1SAFQAw%3D%3D" target='_blank' rel="noreferrer">
                            608-A, Dirvox Business Park, Dantal Jatauli Road, Kanker Khera, Meerut , Uttar Pradesh 250001
                            </a>
                        </p>
                    </div>
                </div>
